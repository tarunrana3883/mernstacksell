...
exports.createuser = async (req, res) => {
    try {
        ...
        const data = req.body;
        if(data.password==undefined){ return res.status(400).send({ status:false , msg:"provide password first!" })
        }
    ...
    if(ImageData == undefined) {
        ...
        return res.status(201).send({ status:true , msg:"user data created sucessfully!" , data: createdata})
    }
